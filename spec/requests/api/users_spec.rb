...
describe API::Users do
  ...
  describe "GET /users/:id" do
    ...
    context "when user's username is used" do
      it 'returns a user' do
        get api("/users/#{URI::encode(user.username)}", user)
  ...
  describe "PUT /users/:id" do
    ...
    context "when user's username is used" do
      it 'updates user with his own username' do
        put api("/users/#{URI::encode(user.username)}", admin), username: user.username
  ...
  describe "POST /users/:user_id/keys" do
    ...
    context "when user's username is used" do
      it "creates ssh key" do
        key_attrs = attributes_for :key
        expect do
          post api("/users/#{URI::encode(user.username)}/keys", admin), key_attrs
        end.to change { user.keys.count }.by(1)
      end
    end
    ...
    context 'when authenticated' do
      ...
      context "when user's username is used" do
        it 'returns array of ssh keys' do
          ...
          get api("/users/#{URI::encode(user.username)}/keys", admin)
    ...
    context 'when authenticated' do
      ...
      context "when user's username is used" do
        it 'deletes existing key' do
          ...
          expect do
            delete api("/users/#{URI::encode(user.username)}/keys/#{key.id}", admin)
  ...
  describe 'POST /users/:user_id/gpg_keys' do
    ...
    context "when user's username is used" do
      it 'creates GPG key' do
        key_attrs = attributes_for :gpg_key
        expect do
          post api("/users/#{URI::encode(user.username)}/gpg_keys", admin), key_attrs
    ...
    context 'when authenticated' do
      ...
      context "when user's username is used" do
        it 'returns array of GPG keys' do
          ...
          get api("/users/#{URI::encode(user.username)}/gpg_keys", admin)
    ...
    context 'when authenticated' do
      ...
      context "when user's username is used" do
        it 'deletes existing key' do
          ...
          expect do
            delete api("/users/#{URI::encode(user.username)}/gpg_keys/#{gpg_key.id}", admin)
    ...
    context 'when authenticated' do
      ...
      context "when user's username is used" do
        it 'revokes existing key' do
          ...
          expect do
            post api("/users/#{URI::encode(user.username)}/gpg_keys/#{gpg_key.id}/revoke", admin)
  ...
  describe "POST /users/:user_id/emails" do
    ...
    context "when user's username is used" do
      it "creates email" do
        email_attrs = attributes_for :email
        expect do
          post api("/users/#{URI::encode(user.username)}/emails", admin), email_attrs
        end.to change { user.emails.count }.by(1)
      end
    end
    ...
    context 'when authenticated' do
      ...
      context "when user's username is used" do
        it 'returns array of emails' do
          ...
          get api("/users/#{URI::encode(user.username)}/emails", admin)
    ...
    context 'when authenticated' do
      ...
      context "when user's username is used" do
        it 'deletes existing email' do
          ...
          expect do
            delete api("/users/#{URI::encode(user.username)}/emails/#{email.id}", admin)
  ...
  describe "DELETE /users/:id" do
    ...
    context "when user's username is used" do
      it "deletes user" do
        Sidekiq::Testing.inline! { delete api("/users/#{URI::encode(user.username)}", admin) }
  ...
  describe 'POST /users/:user_id/block' do
    ...
    context "when user's username is used" do
      it 'blocks existing user' do
        post api("/users/#{URI::encode(user.username)}/block", admin)
        expect(response).to have_gitlab_http_status(201)
        expect(user.reload.state).to eq('blocked')
      end
    end
  ...
  describe 'POST /users/:user_id/unblock' do
    ...
    context "when user's username is used" do
      it 'unblocks existing user' do
        post api("/users/#{URI::encode(user.username)}/unblock", admin)
        expect(response).to have_gitlab_http_status(201)
        expect(user.reload.state).to eq('active')
      end
    end
  ...
  describe 'GET /users/:user_id/impersonation_tokens' do
    ...
    context "when user's username is used" do
      it 'returns an array of inactive personal access tokens if active is set to false' do
        get api("/users/#{URI::encode(user.username)}/impersonation_tokens?state=inactive", admin)
  ...
  describe 'POST /users/:user_id/impersonation_tokens' do
    ...
    context "when user's username is used" do
      it 'creates a impersonation token' do
        post api("/users/#{URI::encode(user.username)}/impersonation_tokens", admin),
             name: name,
             expires_at: expires_at,
             scopes: scopes,
             impersonation: impersonation
  ...
  describe 'GET /users/:user_id/impersonation_tokens/:impersonation_token_id' do
    ...
    context "when user's username is used" do
      it 'returns a personal access token' do
        get api("/users/#{URI::encode(user.username)}/impersonation_tokens/#{impersonation_token.id}", admin)
  ...
  describe 'DELETE /users/:user_id/impersonation_tokens/:impersonation_token_id' do
    ...
    context "when user's username is used" do
      it 'revokes a impersonation token' do
        delete api("/users/#{URI::encode(user.username)}/impersonation_tokens/#{impersonation_token.id}", admin)
